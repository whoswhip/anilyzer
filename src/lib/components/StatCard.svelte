        ...
        {#if tooltip}
            <div class="relative group">
                ...
                <div 
                    ...
                    class="absolute bottom-full mb-2 px-2 py-1 bg-slate-925 border border-slate-700 text-white text-sm rounded whitespace-nowrap opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity {tooltipPosition === 'left' ? 'left-0' : tooltipPosition === 'center' ? 'left-1/2 -translate-x-1/2' : 'right-0'}"
                >
                    {tooltip}
                </div>
            </div>
